...
class MediaController extends OCSController {
	...
	public function create(
		...
		return new DataResponse(
			$this->mediaService->create($this->userId(), $title, $artist, $format, $year, $barcode, $notes, $status)
		);
	}
	...
	public function update(
		...
		return new DataResponse(
			$this->mediaService->update($id, $this->userId(), $title, $artist, $format, $year, $barcode, $notes, $status)
		);
	}
